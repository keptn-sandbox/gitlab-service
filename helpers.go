...
import (
	...
	keptnlibs "github.com/keptn/go-utils/pkg/lib"
 ...
 */
func getKeptnResource(keptnEvent baseKeptnEvent, resource string, logger *keptnlibs.Logger) (string, error) {
 ...
 */
func _getKeptnResourceFromLocal(keptnEvent baseKeptnEvent, resource string, logger *keptnlibs.Logger) (string, error) {
...
/*
func executeCommand(command string, args []string, logger *keptnlibs.Logger) (bool, error) {
	res, err := .ExecuteCommand(command, args)
...
//
func sendConfigurationChangeEvent(shkeptncontext string, incomingEvent *cloudevents.Event, project, service, stage string, labels map[string]string, logger *keptnlibs.Logger) error {
...
//
func sendDeploymentFinishedEvent(shkeptncontext string, incomingEvent *cloudevents.Event, project, service, stage, teststrategy, deploymentstrategy, image, tag, deploymentURILocal, deploymentURIPublic string, result string, labels map[string]string, logger *keptnlibs.Logger) error {
	source, _ := url.Parse("gitlab-service")
	contentType := "application/json"
...
//
func sendTestsFinishedEvent(shkeptncontext string, incomingEvent *cloudevents.Event, project, service, stage, teststrategy, deploymentstrategy string, startedAt, finishedAt time.Time, result string, labels map[string]string, logger *keptnlibs.Logger) error {
	source, _ := url.Parse("gitlab-service")
	contentType := "application/json"
